...
export class DOMRenderer {
  private readonly width = 860;
  private readonly height = 1120;
  private readonly rowH = 22;
  private readonly top = 48;
  ...
  private readonly cBidBook = 0;
  private readonly cBidPrint = 155;
  private readonly cPrice = 250;
  private readonly cAskPrint = 355;
  private readonly cAskBook = 450;

  constructor(
    private readonly orderBook: OrderBook,
    private readonly myOrders: MyOrderManager,
    private readonly mountEl: HTMLElement,
    private readonly onClick: (price: number, side: Side) => void
  ) {}
  ...
  private drawTexts(snap: DOMSnapshot): void {
    const ctx = this.ctx;
  ...
  private handleClick = (ev: MouseEvent): void => {
    ...
    const side: Side = x < this.cPrice ? 'bid' : 'ask';
